...
<div id="login-box">
        <div id="state">
            ...
            <div>
                <div id="main-tab-box">
                    <ul id="main-tab">
                        <li class="current"><a href="#login-abc">登录</a></li>
                ...
                <div class="content reg-container" id="login" >
                    ...
                    <form class="form form-horizontal" id="form-login" th:action="@{/login}">
    ...
    <div class="menu lf">
            ...
            <ul class="select">
                <li class="city1">
                   <select name="" id="start">
                       <option value="hz" selected>广州</option>
                       <option value="wz">深圳</option>
                   </select>
                </li>
            </ul>
        </div>
        ...
        <div class="top-nav">
            <ul class="hd">
                ...
                <li>
                    <a href="/kknq/products">
                        <span>Products</span>
                        <br>
                        蛋糕目录</a>
                </li>
                <li>
                    <a href="/kknq/happiness">
                        <span>Happiness</span>
                        <br>
                        述说幸福</a>
                </li>
                ...
                <li>
                    <a href="/kknq/center">
                        ...
                        会员中心</a>
                        <ul class="list">
                            <li><a href="/kknq/vip/activities">会员活动</a></li>
                            <li><a href="/kknq/vip/application">会员申请</a></li>
                            <li><a href="/kknq/vip/diy">会员特享DIY</a></li>
                        </ul>
                </li>
            </ul>
        </div>
